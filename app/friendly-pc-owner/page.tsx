...
export const metadata: Metadata = {
  ...
  description:
    "Thinking about becoming a Friendly PC owner? ClinX Academy teaches physicians the business, operations, compliance, and legal structures behind PC ownership — so you can lead with confidence.",
};
...
const whatYouNeed = [
  ...
  {
    title: "Equity & Ownership Economics",
    description:
...
const faqs = [
  ...
  },
  {
    ...
    a: "Compensation varies significantly based on the scope of the arrangement, the organization, and the physician's role. Arrangements that include clinical oversight, operational leadership, or equity participation can generate $150K–$500K+ annually. The more business fluency you bring to the negotiation, the better the terms you can command.",
  },
  {
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "PC with fractional operational leadership role", range: "$100K–$250K/yr" },
                  { label: "PC with full-time leadership role", range: "$200K–$500K+/yr" },
                ].map((item) => (
